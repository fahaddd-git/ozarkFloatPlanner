...
// add river monitoring sites
app.post("/add_river_station", (req, res) => {
});
...
app.get("/available", cors(corsOptions), (req, res)=>{
    ...
    river.findRiverIdName(projection).then(rivers => {
...
app.get("/riverbed/:_id", cors(corsOptions), (req, res) => {
    ...
    .then(river => {
        ...
        if (river !== null) {
            ...
            riverData = lineString(riverData.features[0].geometry.coordinates.flat(1))
