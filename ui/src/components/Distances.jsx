...
export default function Distances({ setMeasurements, markers, data, setSlice }) {
    ...
    useEffect(() => {
            ...
            if (markers.length > 1){
                ...
                const start = [markers[markersLength-2].lng, markers[markersLength-2].lat];
                const end = [markers[markersLength-1].lng, markers[markersLength-1].lat];
                ...
                // update the states
                setMeasurements(oldMeasurements=>[...oldMeasurements, travelDistance])
